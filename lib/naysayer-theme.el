...
(defcustom naysayer-theme-dark "#052b2a" "Primary colors - dark" :type 'string :group 'monokai)

(let ((background naysayer-theme-dark)
      (gutters    naysayer-theme-dark)
      (gutter-fg  naysayer-theme-dark)
      (gutters-active naysayer-theme-dark)
      ;; (background "#041818")
      ;; (gutters    "#041818")
      ;; (gutter-fg  "#041818")
      ;; (gutters-active "#041818")
      ;; (background "#062329")
      ;; (gutters    "#062329")
      ;; (gutter-fg  "#062329")
